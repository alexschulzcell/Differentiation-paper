# =============================================================================
# 21_figures_supplement.R -- the nine supplementary figures
# =============================================================================
...
#
# Inputs   figures/data/*.csv  (from 10_panel_data_main.py and 11_panel_data_supplement.py)
...
main <- function() {
  cat("21_figures_supplement.R -- supplementary figures to", PUB_DIR, "\n")
