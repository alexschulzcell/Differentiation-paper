# -*- coding: utf-8 -*-
"""
12_panel_data_second_cohort.py -- panel data of the second cohort: panel F2F and figure S9.

Purpose  Reshapes the outputs of `06_orthogonal_layers/51_lineage_contrast.py` into four panel
         ...
         51_lineage_contrast.py) and sent the lineage contrast to the
...
def main() -> None:
    print("12_panel_data_second_cohort.py -- panels of supplementary figure S9")
    ...
    # computed across all 18 data sets (04_programme_decomposition/10_decomposition_18_datasets.py),
