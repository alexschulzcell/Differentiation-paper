# -*- coding: utf-8 -*-
"""
50_disease_genes_two_layers.py -- work package WS1: "two layers".
...
`08_disease_gene_orthogonality/11_human_genetics_anchor.py` (grid from
...
def raster(G: pd.DataFrame) -> pd.DataFrame:
    ...
    11_human_genetics_anchor.py, so that the same positive control applies."""
