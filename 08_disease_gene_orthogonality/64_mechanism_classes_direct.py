...
Uses the draw mechanism from 08_disease_gene_orthogonality/11_human_genetics_anchor.py unchanged
...
W = pathlib.Path.cwd()
spec = importlib.util.spec_from_file_location("anker", W/"reference_implementations"/"11_human_genetics_anchor.py")
