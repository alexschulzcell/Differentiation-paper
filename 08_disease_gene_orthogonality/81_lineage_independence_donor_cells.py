# -*- coding: utf-8 -*-
"""
81_lineage_independence_donor_cells.py -- WS6, the central P2 check.
...
WHY not the 18 study-dWT vectors (80_lineage_independence_crossarm.py):
...
trap itself in `08_disease_gene_orthogonality/33_donor_circularity_control.py` (MODULBILDEND set) and
