# =============================================================================
# 60_mechanism_classes_go_build.R -- WS2: seven mechanism classes of the skeletal-dysplasia
# disease genes, defined via external, versioned GO term sets.
#
# Follows LITERALLY the same pattern as 08_disease_gene_orthogonality/10_secretion_go_sets.R (the same
