# -*- coding: utf-8 -*-
"""
29_calibration_gene_space.py -- which gene space belongs under the calibration?

Occasion: `reference_implementations/56_calibration_eighteen.py` did not
...
maps come from GENCODE v46 -- but a filter:
    ...
    reference_implementations/01_internal_gene_map.py).
...
(`reference_implementations/_module.py::kontrast`), the same seed:
