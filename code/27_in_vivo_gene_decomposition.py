# -*- coding: utf-8 -*-
"""
27_in_vivo_gene_decomposition.py -- is the in vivo trend broadly carried?
...
WITHIN the specimen, `code/20_in_vivo_donor_test.py`, imported unchanged), on
...
`reference_implementations/_module.py`, the trend test from
`code/20_in_vivo_donor_test.py`, the pseudobulk matrix from
`code/26_in_vivo_pseudobulk.py`. As a SELF-TEST the module contrast of the
...
NZIEHUNGEN = 20000
SEED = 20260822          # as in ws4_invivo_wachstumsfuge.py
...
def trendtest():
    """The donor-stratified trend test from code/20_in_vivo_donor_test.py --
