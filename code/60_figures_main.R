# =============================================================================
# 60_figures_main.R -- the six main figures
# =============================================================================
...
#          never touched.
#
# Inputs   figures/data/*.csv  (written by code/50_panel_data.py)
...
f2d <- function() {
  ...
  # decision rule is in code/24_gene_sets_v2.R. The sensitivity rows (the
...
f2f_zerlegung <- function() {
  ...
  # by code/25_decomposition_eighteen.py. The single case GSE151315 (H3K27ac)
...
# =============================================================================
main <- function() {
  cat("60_figures_main.R -- main figures to", PUB_DIR, "\n")
