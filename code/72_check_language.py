"""
72_check_language.py -- no German prose anywhere in what is published.
...
def main() -> int:
    sag("72_check_language.py -- English throughout in everything published")
    sag("")
    alle: list[str] = []
    ...
    PRUEFER = {"71_check_references.py", "72_check_language.py",
               "64_build_submission.py", "_display.py"}
    for ordner in ("code", "reference_implementations", "figure_style"):
        for p in sorted((WURZEL / ordner).rglob("*")):
