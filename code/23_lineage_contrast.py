# -*- coding: utf-8 -*-
"""
23_lineage_contrast.py -- the lineage contrast, second attempt.
...
The metrics come unchanged from `reference_implementations/_module.py`
(`kontrast`, `konkordanz`) and `reference_implementations/_marker.py`. No
...
def main() -> None:
    log("=" * 78)
    log("23_lineage_contrast.py -- second attempt on an independent cohort")
    log("=" * 78)
