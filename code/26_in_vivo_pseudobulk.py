# -*- coding: utf-8 -*-
"""
26_in_vivo_pseudobulk.py -- store the pseudobulk matrix of the limb atlas once.

Purpose  `reference_implementations/followup/ws4_invivo_wachstumsfuge.py` builds
...
symbol resolution as in `ws4_invivo_wachstumsfuge.py`. That it is the same
...
# --- everything from here on is word for word as in ws4_invivo_wachstumsfuge.py
MIN_ZELLEN = 5
SEED = 20260822
