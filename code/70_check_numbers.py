# -*- coding: utf-8 -*-
"""
70_check_numbers.py -- every number of the manuscript against its panel file.
...
def main() -> None:
    ...
    # ones. The decision rule is in code/24_gene_sets_v2.R.
    ...
    # code/27_in_vivo_gene_decomposition.py; 10 % is the rule, the rest is
    # descriptive.
    ...
    # in the header of code/33_postnatal_growth_plate_test.py; the positive
