# -*- coding: utf-8 -*-
"""
32_postnatal_growth_plate_annotation.py -- our own clustering of the postnatal
...
5) Disjointness check (BLOCKING): the genes that ANNOTATE the zones and the
   ...
   reference_implementations/_marker.py) must be disjoint. On a collision the
...
Inputs   the unpacked GEO archive of the postnatal series (four fresh samples)
         ...
         reference_implementations/_marker.py, reference_implementations/_module.py
...
MIN_ZELLEN = 5           # as in WS4 and code/26_in_vivo_pseudobulk.py
...
SEED_HG = 20260822       # background draw, as in code/26_in_vivo_pseudobulk.py
N_HG = 4000
...
def main() -> None:
    ...
    # ---- pseudobulk matrix (analogous to code/26_in_vivo_pseudobulk.py) ----
