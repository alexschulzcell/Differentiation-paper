...
by 50_panel_data.py, 51_supplement_data.py and 52_s9_data.py from their
...
names, and column_glossary.csv (written by code/_glossary.py from the same
...
WERTE = {
    ...
    "voll": "full",
    "gefiltert": "filtered",
    # case labels of the external gene-set analysis (24_gene_sets_v2.R)
