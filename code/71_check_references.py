"""
71_check_references.py -- the two-way cross-check of the reference apparatus
...
happens at package build time (64_build_submission.py), not here.
...
def main() -> int:
    ...
    say("71_check_references.py -- two-way cross-check")
