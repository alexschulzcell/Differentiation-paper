# =============================================================================
# 20_detection_limit_scan.R -- S6 step C: the scan in the DISCOVERY HALF, its empirical noise
...
log("################################################################")
log("# 20_detection_limit_scan.R -- S6 step C | PREREG_S6.md section 4, dated 2026-08-19")
