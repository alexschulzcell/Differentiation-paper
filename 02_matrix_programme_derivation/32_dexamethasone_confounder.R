# =============================================================================
# 32_dexamethasone_confounder.R -- EXPLORATORY. The reservation raised in the
...
cat("################################################################\n")
cat(sprintf("# 32_dexamethasone_confounder.R | MSigDB %s | msigdbr %s | retrieved 2026-08-19\n",
