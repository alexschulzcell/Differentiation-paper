# -*- coding: utf-8 -*-
"""
14_hypertrophic_zone_sensitivity.py -- does the fetal in vivo trend hang on the
...
NO REIMPLEMENTATION: test() is imported from 07_in_vivo_growth_plate/12_fetal_donor_trend_test.py,
...
def main() -> None:
    ...
    # required values in 10_check_numbers.py have a script as their source and
