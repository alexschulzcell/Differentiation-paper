# -*- coding: utf-8 -*-
"""
10_fetal_limb_atlas_pseudobulk_build.py -- WS4: anchoring the fixed 173-gene program in
...
Statistic: `00_shared/_module.py: kontrast` (contrast of two gene sets against
...
AUS_A = WURZEL / "derived_data" / "followup"
