# -*- coding: utf-8 -*-
"""
12_fetal_donor_trend_test.py -- donor-stratified trend test of the in vivo axis
...
def test(df: pd.DataFrame, label: str, rang=None,
    ...
    07_in_vivo_growth_plate/21_postnatal_growth_plate_test.py can use the same implementation
