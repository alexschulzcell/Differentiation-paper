# =============================================================================
# 60_gene_sets_build.R -- FIX the broad gene sets and store them.
#
# Separate from the analysis (`06_orthogonal_layers/61_gene_set_enrichment.R`) and run before it: the
...
writeLines(c(
  ...
  "",
  sprintf("Created %s by `06_orthogonal_layers/60_gene_sets_build.R`. **Not changed after",
          ABRUF),
  "creation.** The analysis (`06_orthogonal_layers/61_gene_set_enrichment.R`) reads",
