...
(02_matrix_programme_derivation/31_derive_matrix_programme.py) in a form
...
00_shared/_module.py `konkordanz`, identical statistic).
...
def concordance(delta: pd.Series, ri: pd.Series, background: pd.Series,
    ...
    00_shared/_module.py konkordanz (concordance branch)."""
