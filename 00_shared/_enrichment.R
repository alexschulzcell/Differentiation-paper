...
# exactly here. `08_disease_gene_orthogonality/82_programme_annotation_enrichment.R` (narrow
# GO sets) and `06_orthogonal_layers/61_gene_set_enrichment.R` (broad, independently curated sets)
# call the same function; they differ only in the gene sets they pass in.
#
# Extracted on 2026-08-24 from 82_programme_annotation_enrichment.R, unchanged in its
# computation. Equivalence is proven: after extraction 82_programme_annotation_enrichment.R
