# -*- coding: utf-8 -*-
"""
53_diagnosis_screening.py -- phase M-C: the shear on real diagnoses.
...
All 127 series of the manual screening from `50b_screening.py` are audited,
...
spec = importlib.util.spec_from_file_location(
    "p50c", pathlib.Path(__file__).resolve().parent / "50c_check_candidates.py")
