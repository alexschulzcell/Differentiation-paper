# -*- coding: utf-8 -*-
"""
11_dnam_sensitivity.py -- layer A, follow-up check of the null finding.

10_dnam_GSE33896.py finds no direction of the fixed 173-gene module on the
...
spec = importlib.util.spec_from_file_location(
    "a10", pathlib.Path(__file__).resolve().parent / "10_dnam_GSE33896.py")
