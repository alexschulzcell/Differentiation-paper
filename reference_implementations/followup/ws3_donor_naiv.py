# -*- coding: utf-8 -*-
"""
ws3_donor_naiv.py -- work package WS3: does the naive state (day 0) carry
information about the later differentiation response of the same donor?

Uses the six loaders from reference_implementations/54b_cells.py (not rewritten,
imported) to form, per donor cell, the module value IN THE NAIVE ARM
(`basis`, z scale) -- 54b_cells.py stores this value only AVERAGED OVER
...
averaged away before saving -- 54b_cells.py line ~372).
