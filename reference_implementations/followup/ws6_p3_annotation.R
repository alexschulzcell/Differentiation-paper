# =============================================================================
# ws6_p3_annotation.R -- WS6 check P3: what is the 173-gene module, substantively?
#
...
# The enrichment test has lived since 2026-08-24 in reference_implementations/_enrichment.R --
# one implementation for the narrow (here) and the broad sets
# (code/24_gene_sets_v2.R). Computation unchanged.
