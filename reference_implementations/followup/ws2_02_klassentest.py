# -*- coding: utf-8 -*-
"""
ws2_02_klassentest.py -- work package WS2: tests mechanism classes of the
...
`reference_implementations/followup/ws2_01_go_saetze.R`. The draw mechanism (expression- and
length-matched null) is imported verbatim from
`reference_implementations/52_human_genetics_anchor.py`, not reimplemented.
...
spec = importlib.util.spec_from_file_location(
    "anker52", WURZEL / "reference_implementations" / "52_human_genetics_anchor.py")
...
def main() -> None:
    ...
    log("Draw mechanism verbatim from reference_implementations/52_human_genetics_anchor.py")
    ...
    # ---------------------------------------------------- positive control
    log("\n" + "-" * 78)
    log("POSITIVE CONTROL (reproduced from reference_implementations/52_human_genetics_anchor.py)")
