# =============================================================================
# 04_load.R -- Loads the reference implementation AND the eleven data sets,
#              without implementing the metric a second time and without
#              altering 03_metric.R.
# =============================================================================
# The S3 brief, section 0.3: "do not rewrite it, call it."
#
# THE PROCEDURE, and why it has to be this way:
# 03_metric.R defines at the top everything that is needed (the gene sets,
...
FP   <- file.path(SESSIONS, "03_Metrik_Elf_Punkte",
                  "reference_implementations", "03_metric.R")
...
cat(sprintf("04_load.R: %d expressions; definitions < line %d, loading block %d..%d\n",
...
cat(sprintf("04_load.R: %d data sets loaded.\n", length(DATEN)))
