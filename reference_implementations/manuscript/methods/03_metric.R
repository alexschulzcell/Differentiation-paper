# =============================================================================
# 03_metric.R -- The metric per PRAEREG_Gesamtstudie.md §2 across all
...
# 04_load.R, the tree of raw analysis sessions is an explicit, overridable
...
log("################################################################")
log("# 03_metric.R -- PRAEREG §2 ueber alle elf Punkte")
...
source(file.path(HIER, "reference_implementations", "03a_data.R"))
NEUMETA <- list(
