# =============================================================================
# 03b_data_s5.R -- Brings the GEO matrices newly included in S5 step B into
...
#
# The same PROJECT CONVENTION applies as in 03a_data.R: if several
...
# as in 03a_data.R: for GSE102732 (RPKM, log2), GSE145235 (FPKM), GSE137035
...
# Symbol -> Ensembl, word-for-word procedure as in 03a_data.R (gse218101)
sym2ens5 <- function(X) {
